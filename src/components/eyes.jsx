...
function Eyes() {
    ...
    return (
        <div className="eyes w-full h-screen overflow-hidden">
            <div data-scroll data-scroll-speed='-0.7' className="relative w-full h-full bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')] bg-cover bg-center">
                <div className="absolute flex gap-6 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
                    ...
                    <div className="w-[15vw] h-[15vw] rounded-full bg-white flex items-center justify-center">
                        <div className="relative w-2/3 h-2/3 rounded-full bg-black flex items-center justify-center">
                            ...
                            >
                                <div className="w-10 h-10 bg-white rounded-full ml-5"></div>
                            </div>
                        </div>
                    </div>
