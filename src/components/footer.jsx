...
function footer() {
    return (
        <div data-scroll data-scroll-speed="1.2" className='w-full h-screen flex items-center justify-center bg-[#f1f1f1] p-20'>
            <div className=" w-1/2 font-main h-full flex flex-col justify-between ">
                <div className="heading w-full ">
                    <div className=" text-9xl leading-none uppercase">Eye-</div>
                    <div className=" text-9xl leading-none uppercase">Opening</div>
                </div>
                <div className="img">
            ...
            <div className="w-1/2 h-screen p-20 ">
                <h1 className='uppercase font-main text-9xl leading-none  '>presentations</h1>
                <div className='links mt-10 '>
                    {["facebook", "instagram", "twitter"].map((item, index) => (
                        <a key={index} className='block font-semibold uppercase '>{item}</a>
                    ))}
                </div>
            </div>
        </div>
